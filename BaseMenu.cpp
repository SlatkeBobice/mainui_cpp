...
unsigned int		uiColorHelp         = 0xFFFFFFFF;	// 255, 255, 255, 255	// hint letters color
unsigned int		uiPromptBgColor     = 0xFF000000;	// 0,	0,	 0,   255	// dialog background color
unsigned int		uiPromptTextColor   = 0xFFFFFFFF;	// 255, 255, 255, 255	// dialog or button letters color
unsigned int		uiPromptFocusColor  = 0xFFFFFFFF;	// 255, 255, 255, 255	// dialog or button focus letters color
unsigned int		uiInputTextColor    = 0xFFFFFFFF;	// 255, 255, 255, 255
unsigned int		uiInputBgColor      = 0xFFFFFFFF;	// 255, 255, 255, 255	// field, scrollist, checkbox background color
unsigned int		uiInputFgColor      = 0xFFFFFFFF;	// 255, 255, 255, 255	// field, scrollist, checkbox foreground color
...
unsigned int		uiColorBlack        = 0xFF000000;	// 0,   0,   0,   255	// some controls background
unsigned int		uiColorConsole      = 0xFFFFFFFF;	// 255, 255, 255, 255
